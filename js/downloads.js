...
window.downloadMaterial = function(id) {
  if (id === 'balance-sheet') {
    ...
    const html = '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Credit Health Checklist</title><style>body{font-family:sans-serif;padding:2rem;max-width:600px;margin:0 auto}h1{color:#059669}ul{line-height:2}input[type=checkbox]{margin-right:0.5rem}</style></head><body><h1>Credit Health Checklist</h1><ul><li>□ Check credit report annually</li><li>□ Pay bills on time</li><li>□ Keep utilization under 30%</li><li>□ Avoid opening too many accounts</li><li>□ Build emergency fund</li></ul><p style="font-size:0.8rem;color:#666">FinanceForStudents</p></body></html>';
    const blob = new Blob([html], { type: 'text/html' });
